...
import project4 from '../assets/project/1.webp'
               ...
               <section id='projects' className="h-max py-12">
                    ...
                    <div className="justify-center max-w-4xl mx-auto px-10">
                         ...
                         <div className="flex justify-center flex-wrap max-w-5xl mx-auto mt-10 gap-10 gap-y-20">
                              <ProjectCard projectName='INFI Digital' projectDesc='Digital Agency based in Sri Lanka Still in Development and will launch soon..' projectImg={project4} />
                              <ProjectCard projectName='FloxTravel' projectDesc='Tour Agency based in Sri Lanka Still in Development and will launch soon..' projectImg={project5} />
                              <ProjectCard projectName='NatureLanka Travels' projectDesc='Tour Agency based in Germany Still in Development and will launch soon..' projectImg={project3} />
                              ...
                              <ProjectCard projectName='INFI-NITY' projectDesc='A Website that i made for get-together party using Framer Motion and GSAP' projectImg={project2} />
                         </div>
                    </div>
               </section >
          </>
