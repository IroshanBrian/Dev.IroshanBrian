...
import project2 from '../assets/project/3.jpg'
          ...
          <section className="h-max py-12">
               <div className="max-w-6xl mx-auto px-4 py-10">
                    <motion.div
                         ...
                         className="mb-8"
                    >
                         <h1 id="about" className="text-white text-4xl font-extrabold border-b-2 border-cyan-500 pb-2">Projects<span className="text-cyan-200 text-5xl">.</span></h1>
                    </motion.div>
               </div>
               <div className="justify-center max-w-4xl mx-auto px-10">
                    <div>
                         <h1 className="text-white font-title text-2xl font-semibold">Latest Projects</h1>
                    ...
                    <div className="flex justify-center flex-wrap max-w-5xl mx-auto mt-10 gap-10 gap-y-20">
                         ...
                         <ProjectCard projectName='3D Portfolio' projectDesc='3D porfolio website that i made while learning ThreeJs,Framer Motion and GSAP' projectImg={project1} />
