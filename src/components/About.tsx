          ...
          <section className="h-max py-12">
               <div className="max-w-6xl mx-auto px-4">
                    <motion.div
                         ...
                         className="mb-8"
                    >
                         <h1 id="about" className="text-white text-4xl font-extrabold border-b-2 border-cyan-500 pb-2">About<span className="text-cyan-200 text-5xl">.</span></h1>
                    </motion.div>
                    <div className="flex flex-wrap lg:flex-nowrap font-title space-y-8 lg:space-y-0 lg:space-x-8">
                         ...
                         >
                              ...
                              <p className="leading-relaxed text-lg mt-5">I am a self-taught professional full stack developer with 3+ years of experience in website development. I specialize in developing and maintaining web applications using a variety of programming languages.</p>
