          ...
          <section className="h-max py-12">
               <div className="max-w-6xl mx-auto px-4">
                    <motion.div
                         ...
                         className="mb-8"
                    >
                         <h1 id="about" className="text-white text-4xl font-extrabold border-b-2 border-cyan-500 pb-2">About Me<span className="text-cyan-200 text-5xl">.</span></h1>
                    </motion.div>
                         ...
                         >
                              ...
                              <div className='ml-5 mt-10'>
                                   ...
                                   <div className="flex mb-5">
                                        ...
                                        <span className="ml-2 font-title text-xl">BSc. CompSci (SLIIT)</span>
                                   </div>
                              </div>
