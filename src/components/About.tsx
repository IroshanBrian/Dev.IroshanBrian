               ...
               <div className="max-w-6xl mx-auto px-4">
                    ...
                    <div className="flex flex-wrap lg:flex-nowrap font-title space-y-8 lg:space-y-0 lg:space-x-8">
                         ...
                         >
                              ...
                              <p className="leading-relaxed text-lg">I am a self-taught professional full stack developer with 3+ years of experience in website development. I specialize in developing and maintaining web applications using a variety of programming languages.</p>
